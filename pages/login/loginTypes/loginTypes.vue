<template>
	<view class="container">
		...
		<view class="list-cell b-b m-t" hover-class="cell-hover" :hover-stay-time="50">
			...
			<image @click="clearText()" class="cell-more yticon iconS" style="width: 30upx;height: 30upx;" src="../../../static/home/5.png"></image>
		</view>
		<view class="list-cell b-b m-t" hover-class="cell-hover" :hover-stay-time="50">
			<image class="cell-more yticon iconS" src="../../../static/home/6.png"></image>
			<input class="uni-input cell-tit" type="text" v-model="numberCode" placeholder="请输入验证码" />
			<button class="mini-btn yticon btn" @click="getCode()" type="primary" size="mini">{{butCode}}</button>
		</view>
		<view class="btns">
			<button class="b-t" @click="goInto()">登录</button>
			<button class="b-f" @click="goregister()">注册</button>
		</view>
	</view>
</template>
...
export default {
	...
	methods: {
		...
		goregister() {
			// this.register();
			uni.navigateTo({
				url: '../register/register?loadingType=' + this.loadingType
			});
		},
		clearText() {
			this.phone = '';
